...
const MetaDecorator = ({ title, description, imgURL }) => {
  ...
  const title =
    props.title !== undefined ? props.title : "Maqay - Agenda ambiental";
  const image =
    props.image !== undefined
      ? props.image
      : "https://assets.speakcdn.com/assets/2059/outreach1.jpg";
  const description =
  ...
  const hashtag =
    props.hashtag !== undefined ? props.hashtag : "#agendaambiental"; */
  return (
    <Helmet>
