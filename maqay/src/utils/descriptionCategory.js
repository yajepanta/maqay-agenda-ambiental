const descriptionCategory = {
 ...
 1. El Perú está entre los 10 países más vulnerables del mundo al Cambio Climático. El país presenta 4 de las 5 características de vulnerabilidad: zonas costeras bajas; zonas áridas y semiáridas; zonas expuestas a inundaciones, sequía y desertificación; y ecosistemas montañosos frágiles.  
  ...
  3. La calidad del recurso hídrico se ve amenazada por las aguas residuales no tratadas provenientes de diferentes fuentes (agrícola, residencial e industrial), el inadecuado manejo de los residuos sólidos, la minería informal e ilegal, entre otras causas.
  ...
  Instituto de Investigaciones de la Amazonía Peruana - IIAP
    ...
    Además cuenta con un Programa Nacional de Conservación de Bosques para la Mitigación del Cambio Climático y un Proyecto Especial Parque Ecológico Nacional "Antonio Raimondi"

    2. El Servicio Nacional de Certificación Ambiental - SENACE es el encargado de revisar y aprobar los Estudios de Impacto Ambiental detallados (EIA-d) de los proyectos de inversión pública, privada o de capital mixto, de mayor envergadura. 
    
    3. El Organismo de Evaluación y Fiscalización Ambiental – OEFA, es el ente rector de la fiscalización ambiental en todo el territorio peruano. 
    
    4. El término gobernanza se refiere a las interacciones entre estructuras, procesos y tradiciones que determinan cómo se ejerce el poder y las responsabilidades, cómo se toman las decisiones y cómo intervienen los ciudadanos u otros actores. La gobernanza incluye los mecanismos, procesos e instituciones mediante los cuales los ciudadanos expresan sus intereses, ejercen sus derechos, satisfacen sus obligaciones y resuelven sus diferencias. 
  ...
  deforestación: `1. El Perú es el noveno país con mayor extensión de bosques del mundo y el cuarto país con mayor extensión de bosques tropicales. 
    ...
    3. Del 2001 al 2018, el Perú ha perdido cerca de 2.3 millones de hectáreas de bosques, una superficie superior a la de El Salvador, por causas como la agricultura migratoria, la tala ilegal, la minería ilegal y el narcotráfico.
  ...
  conservacióndeecosistemas: `1. El Perú ha sido reconocido como uno de los 17 países llamados megadiversos, por ser poseedores en conjunto de más del 70 % de la biodiversidad del planeta. En el país se pueden encontrar más de 20.375 especies de flora, 523 de mamíferos, 1.847 de aves, 446 de reptiles y 1.070 de peces marinos. Además, se encuentran presentes 84 de las 117 zonas de vida del planeta. 
    ...
    3. El Perú se comprometió a tener el 10% de sus áreas costeras y marinas bajo protección. Actualmente, la superficie de áreas marinas protegidas es 2%. 
  
    4. Los pasivos ambientales, son un riesgo permanente y potencial a la salud y a los ecosistemas. Al 2017, se han identificado 3457 pasivos ambientales de hidrocarburos y en el 2020, se han identificado 7956 pasivos mineros. 
   
    5. Las actividades ilegales, como la tala y  minería afectan especialmente a los ecosistemas. Solo en Madre de Dios, a consecuencia de la minería ilegal, se arrasó con 50 mil hectáreas de bosques en los últimos años. 
  ...
  residuossólidosyeconomíacircular: `1. En el año 2017, se generaron más de 7 millones de toneladas de residuos sólidos, el 50% se dispuso adecuadamente en rellenos sanitarios. Y solo se han reciclado 45 mil toneladas de residuos. Lo que no representa ni el 1% del total de residuos generados. 
    ...
    3. En el 2019, se han identificado 1585 botaderos en el país. La superficie degradada por residuos sólidos municipales al 2019, fueron casi 2000 hectáreas. 
   
    4. El país requiere 344 rellenos sanitarios (infraestructura para la disposición final de residuos sólidos), sin embargo, al año 2020 existen 52 rellenos sanitarios.
  ...
  pueblosindígenas: `1. El Perú es el tercer país con mayor presencia de pueblos indígenas, después de Guatemala y Bolivia, que habitan en 55 pueblos indígenas diferentes. 
    ...
    3. 74% de la población indígena no ha terminado  la secundaria. 

    4. Al 2020, se han concluido solo 41 procesos de Consulta Previa, el Congreso de la República nunca realizó un proceso de consulta previa.`,
};
